      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Quality & Sustainability</h2>
            <p className="text-gray-700 mb-6">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Join the Society</h2>
